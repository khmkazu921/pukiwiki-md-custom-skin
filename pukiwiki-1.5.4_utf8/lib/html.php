...
function upload_file_with_ajax(file, onSuccess, onError){
    ...
    var simplemde = new EasyMDE({
        ...
        hideIcons: ["image"],
        showIcons: ["strikethrough", "code", "table", "redo", "heading", "undo", "heading-bigger", "heading-smaller", "heading-1", "heading-2", "heading-3", "upload-image", "clean-block", "horizontal-rule"],
        spellChecker: false,
        renderingConfig: {
        ...
        uploadImage: true,
        imageUploadFunction: upload_file_with_ajax,
...
/* $(".EasyMDEContainer .CodeMirror-wrap").on('paste', function(event){
